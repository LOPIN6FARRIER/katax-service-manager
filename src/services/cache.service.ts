...
export class CacheService {
  ...
  public async del(key: string): Promise<void> {
    try {
      ...
      throw new Error(`Cache del failed: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  public async delMany(keys: string[]): Promise<void> {
    ...
    try {
      ...
      throw new Error(`Cache delMany failed: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  public async exists(key: string): Promise<boolean> {
    try {
      ...
      throw new Error(`Cache exists failed: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  public async ttl(key: string): Promise<number> {
    try {
      ...
      throw new Error(`Cache ttl failed: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  public async expire(key: string, seconds: number): Promise<boolean> {
    try {
      ...
      throw new Error(`Cache expire failed: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  public async incr(key: string): Promise<number> {
    try {
      ...
      throw new Error(`Cache incr failed: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  public async incrBy(key: string, increment: number): Promise<number> {
    try {
      ...
      throw new Error(`Cache incrBy failed: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  public async decr(key: string): Promise<number> {
    try {
      ...
      throw new Error(`Cache decr failed: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  public async mget<T = unknown>(keys: string[]): Promise<(T | null)[]> {
    ...
    try {
      ...
      throw new Error(`Cache mget failed: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  public async mset(entries: [string, unknown][]): Promise<void> {
    ...
    try {
      ...
      throw new Error(`Cache mset failed: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  public async clear(pattern: string = '*'): Promise<number> {
    try {
      const keys = await this.redis.redis!('KEYS', pattern) as string[];
  ...
  public async stats(): Promise<Record<string, string>> {
    try {
      ...
      throw new Error(`Cache stats failed: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
}
